...
export const ReportJob: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="max-w-2xl mx-auto space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Report Job</h1>
          <p className="text-gray-600">
            Help us maintain quality by reporting suspicious or inappropriate job postings
          </p>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-sm text-yellow-800">
            ...
            Only report jobs that violate our community guidelines.
          </p>
        </div>
      </div>
    </div>
